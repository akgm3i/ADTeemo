...
Deno.test('User Routes API', async (t) => {
  ...
  await t.step('PUT /users/:userId/main-role -> should set the main role', async () => {
  ...
  await t.step('DELETE /users/:userId/roles/:role -> should remove the added role', async () => {
  ...
  await t.step('POST /users/:userId/roles -> should fail with an invalid role', async () => {
